...
if(strlen($_SESSION['name'])<3) {
	header("location:listwisata.php"); }
?>
<html>
<head>
<style>
...
<ul>
  <li class="left"><a href="../headlogin_userin.php">Home</a></li>
  <li class="left"><a href="listwisata_userin.php">Tempat Wisata</a></li>
  <li class="left"><a href="contact.asp">Contact</a></li>
  <li class="right"><a class="head" href="login/logout.php">Logout</a></li>
  <li class="right"><a class="head" href="myprofile.php">
  <?php
  echo $_SESSION['name'];
  ?>
  </a></li>
